...
export default class TeamStats extends Component {
    render () {
        ...
        const offense = Math.round((kickingAbilities + ballManipulation +
            passingAbilities + fieldCoverage + gameStrategy + playmakingRisks)/6);
        const total = Math.round((kickingAbilities + ballManipulation +
            passingAbilities + fieldCoverage + gameStrategy + playmakingRisks + duelTackling + blockingAbilities)/8);
            ...
            <div>
                ...
                <div className="row">
                    <div className="col s12 m7">
                        <Radar data={data} width={500} height={500} option={{maintainAspectRatio : false}}/>
                    </div>
